<html>
  <head>
    <title>Formulario Mecanico</title>
    <meta charset="utf-8">
        ...
        <div class="hero-body">
            <div class="container has-text-centered">
                <div class="column is-4 is-offset-4">
                    <h3 class="title has-text-grey">Inserir novo Mecânico:</h3>
                    <div class="box">
                      <form action="insere_mecanico.php" method="post">
                        <br><b>Cpf: </b><br><input type="text" name="cpf" placeholder="Só numeros"  onblur="valida_cpf(cpf)" required><br>
                        ...
                        <b>Especialidade: </b><br><textarea name="especialidade" rows="10" cols="20">  </textarea><br>
